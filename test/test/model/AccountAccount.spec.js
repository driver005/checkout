...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FiberSwaggerExampleApi.AccountAccount();
  });
  ...
  describe('AccountAccount', function() {
    it('should create an instance of AccountAccount', function() {
      // uncomment below and update the code to test AccountAccount
      //var instance = new FiberSwaggerExampleApi.AccountAccount();
      //expect(instance).to.be.a(FiberSwaggerExampleApi.AccountAccount);
    });

    it('should have the property businessProfile (base name: "business_profile")', function() {
      // uncomment below and update the code to test the property businessProfile
      //var instance = new FiberSwaggerExampleApi.AccountAccount();
