...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FiberSwaggerExampleApi.InvoiceItemInvoiceitem();
  });
  ...
  describe('InvoiceItemInvoiceitem', function() {
    it('should create an instance of InvoiceItemInvoiceitem', function() {
      // uncomment below and update the code to test InvoiceItemInvoiceitem
      //var instance = new FiberSwaggerExampleApi.InvoiceItemInvoiceitem();
      //expect(instance).to.be.a(FiberSwaggerExampleApi.InvoiceItemInvoiceitem);
    });
