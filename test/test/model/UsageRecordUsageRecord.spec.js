...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FiberSwaggerExampleApi.UsageRecordUsageRecord();
  });
  ...
  describe('UsageRecordUsageRecord', function() {
    it('should create an instance of UsageRecordUsageRecord', function() {
      // uncomment below and update the code to test UsageRecordUsageRecord
      //var instance = new FiberSwaggerExampleApi.UsageRecordUsageRecord();
      //expect(instance).to.be.a(FiberSwaggerExampleApi.UsageRecordUsageRecord);
    });
