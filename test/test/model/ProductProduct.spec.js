...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FiberSwaggerExampleApi.ProductProduct();
  });
  ...
  describe('ProductProduct', function() {
    it('should create an instance of ProductProduct', function() {
      // uncomment below and update the code to test ProductProduct
      //var instance = new FiberSwaggerExampleApi.ProductProduct();
      //expect(instance).to.be.a(FiberSwaggerExampleApi.ProductProduct);
    });
