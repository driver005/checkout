...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FiberSwaggerExampleApi.FileFile();
  });
  ...
  describe('FileFile', function() {
    it('should create an instance of FileFile', function() {
      // uncomment below and update the code to test FileFile
      //var instance = new FiberSwaggerExampleApi.FileFile();
      //expect(instance).to.be.a(FiberSwaggerExampleApi.FileFile);
    });
