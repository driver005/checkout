...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FiberSwaggerExampleApi.RefundRefund();
  });
  ...
  describe('RefundRefund', function() {
    it('should create an instance of RefundRefund', function() {
      // uncomment below and update the code to test RefundRefund
      //var instance = new FiberSwaggerExampleApi.RefundRefund();
      //expect(instance).to.be.a(FiberSwaggerExampleApi.RefundRefund);
    });
    ...
    it('should have the property instructionsEmail (base name: "instructions_email")', function() {
      // uncomment below and update the code to test the property instructionsEmail
      //var instance = new FiberSwaggerExampleApi.RefundRefund();
      //expect(instance).to.be();
    });
